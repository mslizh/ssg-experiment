...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: Bo5ntlWuCq0t/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <Searchsvg2Icon
              className={classNames(projectcss.all, sty.svg__dTc2L)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__ky9A)}
              role={"img"}
            />
          ),
