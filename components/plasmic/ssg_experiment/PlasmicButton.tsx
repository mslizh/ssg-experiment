...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 58QQqR3De7zb/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__drR4G)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg___4UT71)}
                role={"img"}
              />
            ),
